...
def autoencoder2(hidden1, hidden2, hidden3, hidden4):
    ...
    model.add(Dense(nuits=hidden2, activation='relu'))
    model.add(Dense(nuits=hidden3, activation='relu'))
    model.add(Dense(nuits=hidden4, activation='relu'))
    model.add(Dense(units=784, activation='sigmoid'))
    return model

model = autoencoder2(64, 32)
