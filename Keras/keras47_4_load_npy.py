...
#1. 데이터
x_train = np.load("./_save_npy/keras47_3_train_x.npy")
y_train = np.load("./_save_npy/keras47_3_train_y.npy")

x_test = np.load("./_save_npy/keras47_3_test_x.npy")
y_test = np.load("./_save_npy/keras47_3_test_y.npy")
