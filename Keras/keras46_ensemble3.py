...
# input 2개, output 3개의 앙상블 모델을 만들어라
...
hist = model.fit([x1_train, x2_train], [y1_train, y2_train, y3_train], epochs=100, batch_size=1)
...
dense13 = hist.history["dense_13_loss"]

epochs = range(1, len(loss)+1)

plt.plot(epochs, loss, 'g--', label="training loss")
plt.plot(epochs, dense3, 'r-', label="training dense_3_loss")
plt.plot(epochs, dense8, 'b-', label="training dense_8_loss")
plt.plot(epochs, dense13, 'y-', label="training dense_13_loss")
