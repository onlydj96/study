...
model.save('./_save/keras26_2_save_model.h5') 
...
model2 = load_model('./_save/keras26_2_save_model.h5')
...
print("====================== 2. ModelCheckPoint 출력 =======================")
model3 = load_model('_ModelCheckPoint/keras26_2_MCP.hdf5')
