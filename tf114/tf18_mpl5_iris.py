...
w = tf.compat.v1.Variable(tf.random.normal([x_data.shape[1], 64], mean=0.0, stddev=tf.math.sqrt(2/(13+64)), name='weight'))
...
w4 = tf.compat.v1.Variable(tf.random.normal([4, 3], mean=0, stddev=tf.math.sqrt(2/(4+1)), name='weight3'))
b4 = tf.compat.v1.Variable(tf.zeros([3], name='bias3'))
