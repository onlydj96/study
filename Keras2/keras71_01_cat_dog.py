...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPool2D, GlobalAvgPool2D
...
xy_train = train_datagen.flow_from_directory(
    'D:/_data/kaggle/cat dog/training_set',
    target_size = (50, 50),
    batch_size = 32,
    class_mode = 'binary',
    subset='training',
...
xy_test = test_datagen.flow_from_directory(
    'D:/_data/kaggle/cat dog/test_set',
    target_size= (50, 50),
    batch_size = 32,
    class_mode = 'binary')
